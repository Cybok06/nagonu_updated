    ...
    try:
        ...
        for idx, item in enumerate(cart, start=1):
            ...
            if is_mtn_normal:
                ...
                if chosen_mtn_normal_provider not in {"portal02", "dataconnect", "codecraft"}:
            ...
            if is_mtn_express:
                ...
                if chosen_mtn_express_provider not in {"portal02", "dataconnect", "codecraft"}:
            ...
            if not use_dataconnect and not use_codecraft and not use_portal02:
                ...
                if not api_allowed:
                    ...
                    note = (
                        "API is only used for MTN NORMAL/MTN EXPRESS (Portal02/DataConnect/CodeCraft) or CodeCraft-routed services; queued for manual processing."
                    )

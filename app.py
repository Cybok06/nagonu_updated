...
from routes.admin_campus_balance import admin_campus_balance_bp
...
# Importing this file attaches store creation and Cloudflare image routes to stores_bp.
import routes.store_create  # noqa: F401

from routes.customer_store import customer_store_bp, ensure_customer_store_indexes
...
def create_app():
    ...
    app.register_blueprint(admin_campus_balance_bp)

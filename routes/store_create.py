...
# ============================================================================
# Cloudflare image upload (shared by store logos and store products)
# ============================================================================
@stores_bp.route("/api/store-images/upload", methods=["POST"])
...
def api_store_products_upload_image():
    ...
    try:
        ...
        if image.mimetype and not image.mimetype.lower().startswith("image/"):
        ...
        purpose = (request.form.get("purpose") or "store_product").strip().lower()
        if purpose not in {"store_logo", "store_product"}:
        ...
        images_col.insert_one(
            {
                ...
                "meta": {"module": purpose, "owner_id": str(session.get("user_id"))},
            }
        )
